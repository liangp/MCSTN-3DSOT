...
sys.path.append("..")
import argparse
from eval.detection.utils import category_to_detection_name
from nuscenes import NuScenes
from utils.data_classes import LidarPointCloud, Box
from utils.geometry_utils import BoxVisibility, transform_matrix
from utils.kitti import KittiDB
from utils.splits import create_splits_logs
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nusc_dir', type=str, default='', help='nusc_dir')
    parser.add_argument('--nusc_kitti_dir', type=str, default='', help='transform result output dir')
    parser.add_argument('--nusc_version', type=str, default='v1.0-trainval', help='nusc_version')
    parser.add_argument('--split', type=str, default='train_track', help='dataset split:train,train_track,val')
    args = parser.parse_args()
    kitti = KittiConverter(nusc_dir =args.nusc_dir,
