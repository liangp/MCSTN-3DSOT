...
from ..voxel import DynamicScatter
...
class DynamicVFE(nn.Module):
    ...
    def map_voxel_center_to_point(self, pts_coors, voxel_mean, voxel_coors, track_id=None):
    ...
    def forward(self,
        ...
        if self._with_cluster_center:
            ...
            points_mean = self.map_voxel_center_to_point(coors, voxel_mean, mean_coors, track_id=track_id)
        ...
        features = torch.cat(features_ls, dim=-1)   # 4+3+3
