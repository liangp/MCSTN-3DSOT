...
from modules.msctn_net import MSCTN_Tracking
...
def test_tracking_waymo_format(opts):  
    ...
    for tracklet_index, tracklet_info in enumerate(bench_lists[-1]):
        ...
        Succ, Prec= test_model_waymo_format(opts=opts, model=model, dataset=wod_dataset, batch_id=tracklet_index+1)
