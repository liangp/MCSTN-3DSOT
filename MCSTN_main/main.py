...
parser.add_argument('--n_gpus', type=int, default=4, help='# GPUs')
parser.add_argument('--train_test', type=str, default='train', help='train or test')
parser.add_argument('--model_epoch', type=int, default=40, help='which epoch model to test')
...
def init_opts(opts, manual_opts):
    ...
    opts.data_save_path = os.path.join('/opt/data/private/tracking/mcstn/', ('tiny' if opts.use_tiny else 'full'), opts.rp_which_dataset)
